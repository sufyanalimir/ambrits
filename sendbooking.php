...
if ($_SERVER["REQUEST_METHOD"] === 'POST') {
    ...
    $message = '<p>Dear Sir,<br/><br/> Please find below enquiry received through website for slot booking of ' . $exam . ' exam.</p><br/>
        <br/>
        <table style="border-collapse: collapse;margin-top:10px;">
            <tbody>
                ...
                <tr>
                    <th style="border: 1px solid #000;border-collapse: collapse;padding:5px;">Service</th>
                    <td style="border: 1px solid #000;border-collapse: collapse;padding:5px;">' . $exam . '</td>
                </tr>
                <tr>
